const SignIn = () => {
    return (
        <>
            <div className="py-6 bg-slate-500 min-h-screen block align-middle justify-between">
                    ...
                    <div className="w-full p-8 lg:w-1/2">
                        ...
                        <div className="mt-4">
                            <div className="flex justify-between">
                                ...
                                <a href="#" className="text-xs text-gray-500 hover:text-cyan-700">Forget Password?</a>
                            </div>
                            <input
                                className="bg-gray-200 text-gray-700 focus:outline-none focus:shadow-outline border border-gray-300 rounded py-2 px-4 block w-full appearance-none"
                                type="password" />
                        ...
                        <div className="mt-4 flex place-items-endend float-right">
                            <a href="/" className="text-xs text-gray-500">
                                Don't have an account? <span className="uppercase hover:text-cyan-500">sign up</span>
                            </a>
                        </div>
                    </div>
                </div>
